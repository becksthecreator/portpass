...
export default async function FutprepCeoPage() {
  await requireFutprepStaff(["ceo"], "/futprep/staff/ceo");
      ...
      <section className="staff-workspace-content">
        ...
        <section className="ceo-panel">
          <div className="ceo-panel-head">
            ...
            <Link href="/futprep/staff/admin">Manage registrations →</Link>
          </div>
        ...
        <section className="ceo-panel">
          <div className="ceo-panel-head">
            ...
            <Link href="/futprep/staff/coach">Open coaching area →</Link>
          </div>
          <div className="ceo-session-table">
            {sessions.map((session)=>{
              ...
              return (
                <Link href={`/futprep/staff/coach?session=${session.id}`} key={session.id}>

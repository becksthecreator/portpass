...
export default function PlanPage() {
  return (
    <div className={`bws-theme planner-body ${bwsSerif.variable} ${bwsSans.variable}`}>
      <a className="skip-link" href="#planner-main">Skip to planner</a>
      <header className="site-header inner-header">
        <Link className="brand" href="/weddings/bahamas-by-the-sea" aria-label="Bahamas Weddings By The Sea home"><span>Bahamas</span><small>WEDDINGS BY THE SEA</small></Link>
        <Link className="planner-home" href="/weddings/bahamas-by-the-sea">Back to the main site <span aria-hidden="true">↗</span></Link>
      </header>
      <main className="planner-main" id="planner-main">
        <section className="planner-intro">
          <p className="eyebrow">Plan from anywhere</p>
